<?php errorHandler();?>
<?php echo form_open('pinjaman/edit',array('class'=>'form-horizontal','id'=>'myform'));?>
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group"><label class="col-sm-4 control-label">JUMLAH PINJAMAN</label>
			<div class="col-sm-8"><?=form_input(array('name'=>'jumlah','id'=>'jumlah','class'=>'form-control', 'value'=>$row->JUMLAH,'onkeypress'=>"return numericVal(this,event)", 'onblur'=>"blurObj(this)",'onclick'=>"clickObj(this)"));?> *Angka saja</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-6">
		<div class="form-group"><label  class="col-sm-4 control-label">LAMA PINJAMAN</label>
			<div class="col-sm-8"><?=form_input(array('name'=>'lama','id'=>'lama','class'=>'form-control', 'value'=>$row->LAMA));?> x ANGSURAN</div>
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group"><label class="col-sm-4 control-label">KEPERLUAN</label>
			<div class="col-sm-8"><?=form_textarea(array('name'=>'keperluan','id'=>'keperluan','class'=>'form-control', 'value'=>$row->KEPERLUAN));?>	</div>
		</div>
	</div>
</div>
<hr />
...
$('#myform').submit(function(event) {
	$(this).saveForm('<?php echo base_url('pinjaman/edit');?>','<?php echo base_url('pinjaman');?>');
