		...
		?>
			<tr>
				...
				<td class="form-inline">
					<?php echo form_dropdown('mulai_h[]',range(00,23),$mulai_h,' class="form-control" style="width:70px"');?> <label> :</label> 
					<?php echo form_dropdown('mulai_m[]',range(00,59),$mulai_m,' class="form-control" style="width:70px"');?>
				</td>
				<td class="form-inline">
					<?php echo form_dropdown('selesai_h[]',range(00,23),$selesai_h,' class="form-control" style="width:70px"');?> <label> : </label>
					<?php echo form_dropdown('selesai_m[]',range(00,59),$selesai_m,' class="form-control" style="width:70px"');?>
				</td>
				<td>
