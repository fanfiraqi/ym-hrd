...
<div class="row">
	<div class="col-md-6">
		<div class="form-group"><label  class="col-sm-4 control-label">TANGGAL PELATIHAN</label>
			<div class="col-sm-8">
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group"><label  class="col-sm-4 control-label">NAMA PELATIHAN</label>
			<div class="col-sm-8"><?=form_input(array('name'=>'pelatihan','id'=>'pelatihan','class'=>'form-control'));?>	</div>
		</div>
	</div>
</div>
...
<script>
    $(document).ready(function() {
        $('#dataTables-list').dataTable({
			...
			"sAjaxSource": "<?php echo base_url('pelatihan/json_data');?>"
		});
    });
...
$( "#tanggal" ).datepicker({
	...
	function delThis(idx,  str){	//nik, nama
			...
			if (pilih==true) {
					$.ajax({
					type	: "POST",
					url		: "<?php echo base_url('pelatihan/delThis');?>",
					data	: "idx="+idx+"&proses=pelatihan"+"&field=id",
					timeout	: 3000,  
	...
	function editThis(obj){
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url('pelatihan/editThis');?>',
			data: {
				id:id
			},
			dataType: 'json',
			success: function(msg) {
				...
				if(msg.status =='success'){
					...
					$('#pelatihan').val(msg.data.NAMA_PELATIHAN);
	...
	$('#btsimpan').click(function(){		
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url('pelatihan/saveData');?>",
			data: form_data,				
			dataType: 'json',
			success: function(msg) {
