<?php errorHandler();?>
<?php echo form_open('komponengaji/edit',array('class'=>'form-horizontal','id'=>'myform'));?>
...
<div class="row">
	<div class="col-md-6">
		<div class="form-group"><label class="col-sm-4 control-label">STATUS</label>
			<div class="col-sm-8"><?=form_dropdown('status',array('1'=>'Aktif','0'=>'Tidak Aktif'), $row->ISACTIVE,'id="status" class="form-control"');?>	</div>
		</div>
	</div>
</div>
<hr />
...
$('#myform').submit(function(event) {
	$(this).saveForm('<?php echo base_url('komponengaji/edit');?>','<?php echo base_url('komponengaji');?>');
