...
<div class="table-responsive">
		...
		<tbody>
			<tr class="info">
				...
				<td class="form-inline">
					<?php echo form_dropdown('mulai_h[]',range(00,22),16,' class="form-control" style="width:70px"');?> <label> :</label> 
					<?php echo form_dropdown('mulai_m[]',range(00,59),0,' class="form-control" style="width:70px"');?>
				</td>
				<td class="form-inline">
					<?php echo form_dropdown('selesai_h[]',range(00,22),16,' class="form-control" style="width:70px"');?> <label> : </label>
	...
	<div class="pull-right"><a href="javascript:void(0)" onclick="addrow()" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Hari Lembur</a></div>
